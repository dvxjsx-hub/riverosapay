...
// Se comparte entre /login, /register y /recuperar: las tres son puertas de
// entrada a una cuenta, así que las tres cuentan para el mismo límite por IP
// y por cuenta (evita que alguien esquive el límite de /login probando por
// /register o /recuperar en su lugar).
