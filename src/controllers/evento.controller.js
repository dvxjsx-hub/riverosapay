...
async function crearEvento(req, res) {
  ...
  evento.crearEvento(nuevoEvento); await save(); evento.broadcast(empleadoId);
  await auditoria.registrar({ actorId: empleadoId, actorType: 'user', action: 'crear_evento', resource: 'evento', resourceId: nuevoEvento.id });
...
async function eliminarEvento(req, res) {
  ...
  await auditoria.registrar({ actorId: empleadoId, actorType: 'user', action: 'eliminar_evento', resource: 'evento', resourceId: eliminado.id });
