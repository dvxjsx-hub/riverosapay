...
// Reglas de LOGIN: usuario de 3-15 letras.
const USERNAME_REGEX = /^[a-z]{3,15}$/;

// S3: clave normal de 8-20 caracteres para cuentas NUEVAS y para cualquier
// cambio/recuperación de clave. Las cuentas creadas antes de S3 tenían clave
// de exactamente 6 dígitos: esas siguen siendo válidas para iniciar sesión
// (no se fuerza a nadie a cambiarla), pero ya no se pueden crear ni volver
// a poner claves de 6 dígitos desde ahora en adelante.
const PASSWORD_REGEX = /^.{8,20}$/;
const LEGACY_PASSWORD_REGEX = /^\d{6}$/;
// Solo para el filtro rápido de /login: acepta cualquiera de los dos formatos.
const LOGIN_PASSWORD_REGEX = /^(?:.{8,20}|\d{6})$/;
...
module.exports = {
  ...
  USERNAME_REGEX, PASSWORD_REGEX, LEGACY_PASSWORD_REGEX, LOGIN_PASSWORD_REGEX,
