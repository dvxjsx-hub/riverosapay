...
async function openAmistades() {
  STATE.viewMode = 'amistades';
  marcarTabActiva(null);
  $('#content').innerHTML = `<div class="view-head"><button class="view-back" onclick="volverAInicioDesdeAmistades()">${ICONS.back}</button><span class="view-title">Amistades</span></div><div id="amistades-content"><p class="muted" style="text-align:center;">Cargando tus amistades…</p></div>`;
...
function volverAInicioDesdeAmistades() {
