...
/* Carga el pequeño módulo visual de cuentas verificadas y la protección
   del botón/gesto Atrás de Android, sin alterar la lógica de Eventos. */
cargarModulo('perfilVerificado').catch(err => console.error(err));
cargarModulo('atrasAndroid').catch(err => console.error(err));
