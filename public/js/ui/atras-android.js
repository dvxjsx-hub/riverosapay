...
(function instalarAtrasAndroid(){
  ...
  function volverDentroDeLaApp(){
    ...
    if(STATE.viewMode==='amistades'){
      if(typeof volverAInicioDesdeAmistades==='function')volverAInicioDesdeAmistades();
      return true;
    }
    if(STATE.viewMode==='jefe-ver'||STATE.viewMode==='jefe-historial'){
      STATE.viewMode='jefe-home';
      STATE.jefeView=null;
      if(typeof marcarTabActiva==='function')marcarTabActiva('inicio');
      renderHome();
      return true;
    }
